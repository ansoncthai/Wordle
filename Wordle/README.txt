Anson Thai 933000535

https://youtu.be/zSfZRidVZqc

load/save/logs are not implemented
There is no PHYSICAL DATA STRUCTURE being used. The program reads and writes directly to the grid. It is logically equivalent to a 2d matrix.
